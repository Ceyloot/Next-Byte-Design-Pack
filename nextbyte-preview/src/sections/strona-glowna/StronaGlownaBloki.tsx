...
import { NextByteMarkIcon, OpenAIIcon, AnthropicIcon, GeminiIcon, XaiIcon } from '@/grafiki/znaki-marek'
import { ElevenLabsIcon, KlingIcon } from '@/grafiki/znaki-marek'
import { FAQ, PLANY, przelicznikByte, type Plan } from './data'
import type { HomePage as HomePageId } from './types'
import { AKCENT, TOK_NA_SEK, useTokenTicker, Fan, LocalGpuScene, EncryptionScene, CommitmentDoc, StepGlyph } from '@/grafiki/sceny'
