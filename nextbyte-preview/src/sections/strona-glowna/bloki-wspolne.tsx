...
import {
  ArrowRight, Check, ChevronDown, Sparkles, Shield, Zap, Brain, Camera, NotebookPen, Cpu, Calendar, Users, Clock, Lock, Layers, Gauge, CpuIcon, FileText, Mic, Repeat, CheckCircle2, Globe, Clapperboard, AudioLines, Folder, Search, Type, MonitorPlay, Move, type LucideIcon,
} from 'lucide-react'
import {
  Panel, IconTile, akcentTlo, TechCornerMarks,
} from '@/sections/wspolne/shared'
import { MODULY } from './data'
...
import { OpenAIIcon, AnthropicIcon, GeminiIcon, XaiIcon, GoogleIcon } from '@/grafiki/znaki-marek'
