...
export const MODULY = [
  ...
  },
  {
    ...
    icon: Camera,
    color: AKCENT.studio,
    tag: 'Kreacja Wizualna',
    title: 'Studio Zdjęć 4K i Wideo AI',
    lead: 'Generowanie fotorealistycznych grafik produktowych oraz natychmiastowa zamiana zdjęć w kinowe klipy wideo.',
  ...
  },
  {
    ...
    title: 'Asystent NextByte i automatyzacja',
    lead: 'Autonomiczny agent wykonawczy: układa zadania, rezerwuje kalendarz i pilnuje terminów projektów.',
    models: ['Claude Thinking', 'GPT-5.4 Auto', 'Agentic Loop'],
    bullets: [
      'Wnioski z rozmów same stają się terminami i zadaniami',
      'Automatyczne tworzenie i przypisywanie zadań w zespole',
      'Błyskawiczna analiza plików PDF, Excel i baz wiedzy',
      'Poranne briefy i rekomendacje priorytetów dnia',
    ],
    metryki: [
  ...
  },
  {
    ...
    lead: 'Przeszukiwanie dziesiątek baz, weryfikacja faktów i synteza wyczerpującego raportu w 30 sekund.',
  ...
  },
  {
    ...
    lead: 'Ucz się z certyfikowanych kursów AI lub publikuj własne materiały i zarabiaj na sprzedaży wiedzy w sklepie.',
